package com.app.reservations.domain;
...
public class Reservations {
    ...
    public Reservations(Long id, int users_Id, String itinerary_id, String activity_id, double accommodations_id, String reservations_date, String quantity) {
        this.id = id;
