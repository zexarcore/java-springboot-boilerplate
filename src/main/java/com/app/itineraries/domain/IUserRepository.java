...
@Repository
public interface IUserRepository extends JpaRepository<Itineraries, Long> {
    ...
    @Override
    @NonNull
    Optional<Itineraries> findById(@NonNull Long id);

    // Save a user (already provided by JpaRepository)
    @Override
    @NonNull
    <S extends Itineraries> S save(@NonNull S user);
    ...
    Optional<Itineraries> findByEmail(String email);
