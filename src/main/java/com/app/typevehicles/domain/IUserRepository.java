...
@Repository
public interface IUserRepository extends JpaRepository<TypeVehicles, Long> {
    ...
    @Override
    @NonNull
    Optional<TypeVehicles> findById(@NonNull Long id);

    // Save a user (already provided by JpaRepository)
    @Override
    @NonNull
    <S extends TypeVehicles> S save(@NonNull S user);
    ...
    Optional<TypeVehicles> findByEmail(String email);
